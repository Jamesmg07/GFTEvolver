...
namespace WilsonLoops{
    ...
    private:
        ...
        double g_sqr, gp_sqr, gpp_sqr, inverse_g_sqr, inverse_gp_sqr, inverse_gpp_sqr;
    ...
    public:
        ...
        TwoHDM(const unsigned &num_vector_components, const double &dt, const double &dx, const double &dy, const double &dz);
        virtual ~TwoHDM();
        ...
        */
        ...
        /*
        * Calculates the energy density coming from the spatial part of all Yang-Mills terms.
        * 
        ...
        */
        ...
        /*
        * Calculates the energy density coming the temporal part of all Yang-Mills terms.
        * 

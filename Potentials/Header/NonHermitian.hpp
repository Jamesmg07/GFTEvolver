...
public:
     ...
     * @param        float* field                Pointer to the scalar fields at this position.
     * 
     * @return       vector<float>               Array containing the contribution to each equation of motion.  
     */
    std::vector<float> calcPotentialDerivatives(const float* field);
};